 ...
 * Example:
 * @code
 * FileHandle* sapi::mbed_override_console(int) {
 ...
 */
std::FILE *fdopen(sapi::FileHandle *fh, const char *mode);
 ...
 */
int bind_to_fd(sapi::FileHandle *fh);
