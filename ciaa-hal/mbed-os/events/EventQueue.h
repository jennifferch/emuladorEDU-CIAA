...
#define EVENTS_EVENT_SIZE \
    (EQUEUE_EVENT_SIZE - 2*sizeof(void*) + sizeof(sapi::Callback<void()>))
 ...
 * @ingroup events
 */
class EventQueue : private sapi::NonCopyable<EventQueue> {
public:
     ...
     *                  dispatched
     */
    void background(sapi::Callback<void(int)> update);
    ...
    Event<void(Args...)> event(sapi::Callback<R(BoundArgs..., Args...)> cb, ContextArgs ...context_args);
    ...
    {
        return call(sapi::callback(obj, method));
    }
    ...
    {
        return call(sapi::callback(obj, method), a0);
    }
    ...
    {
        return call(sapi::callback(obj, method), a0, a1);
    }
    ...
    {
        return call(sapi::callback(obj, method), a0, a1, a2);
    }
    ...
    {
        return call(sapi::callback(obj, method), a0, a1, a2, a3);
    }
    ...
    {
        return call(sapi::callback(obj, method), a0, a1, a2, a3, a4);
    }
    ...
    {
        return call_in(ms, sapi::callback(obj, method));
    }
    ...
    {
        return call_in(ms, sapi::callback(obj, method), a0);
    }
    ...
    {
        return call_in(ms, sapi::callback(obj, method), a0, a1);
    }
    ...
    {
        return call_in(ms, sapi::callback(obj, method), a0, a1, a2);
    }
    ...
    {
        return call_in(ms, sapi::callback(obj, method), a0, a1, a2, a3);
    }
    ...
    {
        return call_in(ms, sapi::callback(obj, method), a0, a1, a2, a3, a4);
    }
    ...
    {
        return call_every(ms, sapi::callback(obj, method));
    }
    ...
    {
        return call_every(ms, sapi::callback(obj, method), a0);
    }
    ...
    {
        return call_every(ms, sapi::callback(obj, method), a0, a1);
    }
    ...
    {
        return call_every(ms, sapi::callback(obj, method), a0, a1, a2);
    }
    ...
    {
        return call_every(ms, sapi::callback(obj, method), a0, a1, a2, a3);
    }
    ...
    {
        return call_every(ms, sapi::callback(obj, method), a0, a1, a2, a3, a4);
    }
     ...
     */
    template <typename R>
    Event<void()> event(sapi::Callback<R()> cb);
     ...
     */
    template <typename R, typename B0, typename C0>
    Event<void()> event(sapi::Callback<R(B0)> cb, C0 c0);
     ...
     */
    template <typename R, typename B0, typename B1, typename C0, typename C1>
    Event<void()> event(sapi::Callback<R(B0, B1)> cb, C0 c0, C1 c1);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename C0, typename C1, typename C2>
    Event<void()> event(sapi::Callback<R(B0, B1, B2)> cb, C0 c0, C1 c1, C2 c2);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename B3, typename C0, typename C1, typename C2, typename C3>
    Event<void()> event(sapi::Callback<R(B0, B1, B2, B3)> cb, C0 c0, C1 c1, C2 c2, C3 c3);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename B3, typename B4, typename C0, typename C1, typename C2, typename C3, typename C4>
    Event<void()> event(sapi::Callback<R(B0, B1, B2, B3, B4)> cb, C0 c0, C1 c1, C2 c2, C3 c3, C4 c4);
     ...
     */
    template <typename R, typename A0>
    Event<void(A0)> event(sapi::Callback<R(A0)> cb);
     ...
     */
    template <typename R, typename B0, typename C0, typename A0>
    Event<void(A0)> event(sapi::Callback<R(B0, A0)> cb, C0 c0);
     ...
     */
    template <typename R, typename B0, typename B1, typename C0, typename C1, typename A0>
    Event<void(A0)> event(sapi::Callback<R(B0, B1, A0)> cb, C0 c0, C1 c1);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename C0, typename C1, typename C2, typename A0>
    Event<void(A0)> event(sapi::Callback<R(B0, B1, B2, A0)> cb, C0 c0, C1 c1, C2 c2);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename B3, typename C0, typename C1, typename C2, typename C3, typename A0>
    Event<void(A0)> event(sapi::Callback<R(B0, B1, B2, B3, A0)> cb, C0 c0, C1 c1, C2 c2, C3 c3);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename B3, typename B4, typename C0, typename C1, typename C2, typename C3, typename C4, typename A0>
    Event<void(A0)> event(sapi::Callback<R(B0, B1, B2, B3, B4, A0)> cb, C0 c0, C1 c1, C2 c2, C3 c3, C4 c4);
     ...
     */
    template <typename R, typename A0, typename A1>
    Event<void(A0, A1)> event(sapi::Callback<R(A0, A1)> cb);
     ...
     */
    template <typename R, typename B0, typename C0, typename A0, typename A1>
    Event<void(A0, A1)> event(sapi::Callback<R(B0, A0, A1)> cb, C0 c0);
     ...
     */
    template <typename R, typename B0, typename B1, typename C0, typename C1, typename A0, typename A1>
    Event<void(A0, A1)> event(sapi::Callback<R(B0, B1, A0, A1)> cb, C0 c0, C1 c1);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename C0, typename C1, typename C2, typename A0, typename A1>
    Event<void(A0, A1)> event(sapi::Callback<R(B0, B1, B2, A0, A1)> cb, C0 c0, C1 c1, C2 c2);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename B3, typename C0, typename C1, typename C2, typename C3, typename A0, typename A1>
    Event<void(A0, A1)> event(sapi::Callback<R(B0, B1, B2, B3, A0, A1)> cb, C0 c0, C1 c1, C2 c2, C3 c3);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename B3, typename B4, typename C0, typename C1, typename C2, typename C3, typename C4, typename A0, typename A1>
    Event<void(A0, A1)> event(sapi::Callback<R(B0, B1, B2, B3, B4, A0, A1)> cb, C0 c0, C1 c1, C2 c2, C3 c3, C4 c4);
     ...
     */
    template <typename R, typename A0, typename A1, typename A2>
    Event<void(A0, A1, A2)> event(sapi::Callback<R(A0, A1, A2)> cb);
     ...
     */
    template <typename R, typename B0, typename C0, typename A0, typename A1, typename A2>
    Event<void(A0, A1, A2)> event(sapi::Callback<R(B0, A0, A1, A2)> cb, C0 c0);
     ...
     */
    template <typename R, typename B0, typename B1, typename C0, typename C1, typename A0, typename A1, typename A2>
    Event<void(A0, A1, A2)> event(sapi::Callback<R(B0, B1, A0, A1, A2)> cb, C0 c0, C1 c1);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename C0, typename C1, typename C2, typename A0, typename A1, typename A2>
    Event<void(A0, A1, A2)> event(sapi::Callback<R(B0, B1, B2, A0, A1, A2)> cb, C0 c0, C1 c1, C2 c2);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename B3, typename C0, typename C1, typename C2, typename C3, typename A0, typename A1, typename A2>
    Event<void(A0, A1, A2)> event(sapi::Callback<R(B0, B1, B2, B3, A0, A1, A2)> cb, C0 c0, C1 c1, C2 c2, C3 c3);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename B3, typename B4, typename C0, typename C1, typename C2, typename C3, typename C4, typename A0, typename A1, typename A2>
    Event<void(A0, A1, A2)> event(sapi::Callback<R(B0, B1, B2, B3, B4, A0, A1, A2)> cb, C0 c0, C1 c1, C2 c2, C3 c3, C4 c4);
     ...
     */
    template <typename R, typename A0, typename A1, typename A2, typename A3>
    Event<void(A0, A1, A2, A3)> event(sapi::Callback<R(A0, A1, A2, A3)> cb);
     ...
     */
    template <typename R, typename B0, typename C0, typename A0, typename A1, typename A2, typename A3>
    Event<void(A0, A1, A2, A3)> event(sapi::Callback<R(B0, A0, A1, A2, A3)> cb, C0 c0);
     ...
     */
    template <typename R, typename B0, typename B1, typename C0, typename C1, typename A0, typename A1, typename A2, typename A3>
    Event<void(A0, A1, A2, A3)> event(sapi::Callback<R(B0, B1, A0, A1, A2, A3)> cb, C0 c0, C1 c1);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename C0, typename C1, typename C2, typename A0, typename A1, typename A2, typename A3>
    Event<void(A0, A1, A2, A3)> event(sapi::Callback<R(B0, B1, B2, A0, A1, A2, A3)> cb, C0 c0, C1 c1, C2 c2);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename B3, typename C0, typename C1, typename C2, typename C3, typename A0, typename A1, typename A2, typename A3>
    Event<void(A0, A1, A2, A3)> event(sapi::Callback<R(B0, B1, B2, B3, A0, A1, A2, A3)> cb, C0 c0, C1 c1, C2 c2, C3 c3);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename B3, typename B4, typename C0, typename C1, typename C2, typename C3, typename C4, typename A0, typename A1, typename A2, typename A3>
    Event<void(A0, A1, A2, A3)> event(sapi::Callback<R(B0, B1, B2, B3, B4, A0, A1, A2, A3)> cb, C0 c0, C1 c1, C2 c2, C3 c3, C4 c4);
     ...
     */
    template <typename R, typename A0, typename A1, typename A2, typename A3, typename A4>
    Event<void(A0, A1, A2, A3, A4)> event(sapi::Callback<R(A0, A1, A2, A3, A4)> cb);
     ...
     */
    template <typename R, typename B0, typename C0, typename A0, typename A1, typename A2, typename A3, typename A4>
    Event<void(A0, A1, A2, A3, A4)> event(sapi::Callback<R(B0, A0, A1, A2, A3, A4)> cb, C0 c0);
     ...
     */
    template <typename R, typename B0, typename B1, typename C0, typename C1, typename A0, typename A1, typename A2, typename A3, typename A4>
    Event<void(A0, A1, A2, A3, A4)> event(sapi::Callback<R(B0, B1, A0, A1, A2, A3, A4)> cb, C0 c0, C1 c1);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename C0, typename C1, typename C2, typename A0, typename A1, typename A2, typename A3, typename A4>
    Event<void(A0, A1, A2, A3, A4)> event(sapi::Callback<R(B0, B1, B2, A0, A1, A2, A3, A4)> cb, C0 c0, C1 c1, C2 c2);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename B3, typename C0, typename C1, typename C2, typename C3, typename A0, typename A1, typename A2, typename A3, typename A4>
    Event<void(A0, A1, A2, A3, A4)> event(sapi::Callback<R(B0, B1, B2, B3, A0, A1, A2, A3, A4)> cb, C0 c0, C1 c1, C2 c2, C3 c3);
     ...
     */
    template <typename R, typename B0, typename B1, typename B2, typename B3, typename B4, typename C0, typename C1, typename C2, typename C3, typename C4, typename A0, typename A1, typename A2, typename A3, typename A4>
    Event<void(A0, A1, A2, A3, A4)> event(sapi::Callback<R(B0, B1, B2, B3, B4, A0, A1, A2, A3, A4)> cb, C0 c0, C1 c1, C2 c2, C3 c3, C4 c4);
    #endif
...
protected:
    ...
    sapi::Callback<void(int)> _update;
