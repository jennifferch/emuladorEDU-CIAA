...
public:
     ...
     */
    typedef sapi::Callback<void (nsapi_error_t result, SocketAddress *address)> hostbyname_cb_t;
...
private:
    ...
    /** Call in callback
      ...
      */
    typedef sapi::Callback<nsapi_error_t (int delay_ms, sapi::Callback<void()> user_cb)> call_in_callback_cb_t;
     ...
     *  @return         0 on success, negative error code on failure
     */
    virtual nsapi_error_t call_in(int delay, sapi::Callback<void()> func);
};
