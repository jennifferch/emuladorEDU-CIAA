...
public:
     ...
     */
    virtual void sigio(sapi::Callback<void()> func);
    ...
    MBED_DEPRECATED_SINCE("mbed-os-5.4",
                          "The behaviour of Socket::attach differs from other attach functions in "
                          "mbed OS and has been known to cause confusion. Replaced by Socket::sigio.")
    void attach(sapi::Callback<void()> func);
    ...
    {
        attach(sapi::callback(obj, method));
    }
...
protected:
    ...
    uint32_t _timeout;
    sapi::Callback<void()> _event;
    sapi::Callback<void()> _callback;
#ifdef MBED_CONF_RTOS_PRESENT
